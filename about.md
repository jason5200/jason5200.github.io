...
在智能座舱里写代码的人，相信「输出倒逼输入」。这个博客是我的技术笔记，也是我对车载 Android 与 AI 的思考沉淀。

**写作原则**：

> 源码对照写明 AOSP 标签（当前默认 `android-14.0.0_r67`）。Demo 会标明 Mock 还是真实后端，不把骨架写成「已经量产」。
...
本站基于 [Docsify](https://docsify.js.org) 构建，部署在 GitHub Pages。所有文章开源，欢迎通过 PR 纠错与补充。

> 一起把车载 Android 与 AI 做好玩一点！🚗
