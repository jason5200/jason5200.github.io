...
| 2026-08-19 | [车机冷启动优化实战](articles/perf/cold-start.md) |
| 2026-08-18 | [车机多屏显示：从 Display 到 Surface 的链路](articles/multi-display/multi-display.md) |
| 2026-08-17 | [CarPropertyManager：如何读写车辆属性](articles/carservice-api/carproperty-manager.md) |
| 2026-08-16 | [CarService 架构：从 SystemServer 到车辆服务](articles/car-service/carservice-architecture.md) |
| 2026-08-15 | [车载 Android 全景：AAOS 到底是什么](articles/00-overview/aaos-intro.md) |
...
| 2026-08-27 | [端侧推理性能优化的完整实践](articles/ai/inference-perf.md) |
| 2026-08-27 | [Binder 驱动 binder_proc 与 binder_thread 结构源码](articles/framework/binder-struct-source.md) |
| 2026-08-27 | [CarPropertyService 属性读写源码](articles/car-service/carproperty-source.md) |
| 2026-08-27 | [量化感知训练 QAT 的完整流程](articles/ai/qat.md) |
| 2026-08-27 | [MessageQueue 的 native 层 next 唤醒源码](articles/framework/messagequeue-source.md) |
| 2026-08-27 | [llama.cpp 采样算法的完整源码](articles/ai/llamacpp-sampling.md) |
| 2026-08-27 | [View 硬件加速的完整源码](articles/framework/hw-render-source.md) |
| 2026-08-27 | [Binder 驱动 binder_transaction 的完整源码](articles/framework/binder-transaction-source.md) |
...
| 2026-08-21 | [AMS 启动流程解析](articles/framework/ams-startup.md) |
| 2026-08-20 | [同步屏障与异步消息](articles/framework/sync-barrier.md) |
| 2026-08-18 | [Handler 消息机制：从 Looper 到 MessageQueue](articles/framework/handler-message-mechanism.md) |
| 2026-08-17 | [一次 Binder 通信的完整流程](articles/framework/binder-full-flow.md) |
| 2026-08-16 | [Binder 机制总览：为什么 Android 用它做 IPC](articles/framework/binder-overview.md) |
...
| 2026-08-20 | [大模型上车：端侧推理的可行方案](articles/ai/on-device-llm.md) |

---

> 共 **117 篇**文章，持续更新中。欢迎通过 [GitHub](https://github.com/jason5200) 关注最新动态。
